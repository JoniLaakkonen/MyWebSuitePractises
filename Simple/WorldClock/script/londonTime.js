...
window.addEventListener("load", () => {
    ...
    function londonTime() {
      ...
      document.getElementById('location-london').querySelector("#digital-clock").innerHTML = time;
      document.getElementById('location-london').querySelector("#digital-date").innerHTML = date;
      ...
      let hourHandPos = document.getElementById('location-london').querySelector("#hour-hand");
      let minuteHandPos = document.getElementById('location-london').querySelector("#minute-hand");
      let secHandPos = document.getElementById('location-london').querySelector("#seconds-hand");
