...
window.addEventListener("load", () => {
  newYorkTime();
    function newYorkTime() {
      ...
      document.getElementById('location-newyork').querySelector("#digital-clock").innerHTML = time;
      document.getElementById('location-newyork').querySelector("#digital-date").innerHTML = date;

      let hrRotatePos;
      let minRotatePos;
      let secRotatePos;

      let hourHandPos = document.getElementById('location-newyork').querySelector("#hour-hand");
      let minuteHandPos = document.getElementById('location-newyork').querySelector("#minute-hand");
      let secHandPos = document.getElementById('location-newyork').querySelector("#seconds-hand");
